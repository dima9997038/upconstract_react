    ...
    return (
        <section id="hero" className="hero">
            ...
            <div id="hero-carousel" className="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div className="carousel-item active" style={{backgroundImage: `url(${background6})`}}></div>
                <div className="carousel-item active" style={{backgroundImage: `url(${background7})`}}></div>
                <div className="carousel-item active" style={{backgroundImage: `url(${background8})`}}></div>
                <div className="carousel-item active" style={{backgroundImage: `url(${background9})`}}></div>
